...
" Default colors
"set background=dark
let s:bg = { 'gui': '#051C30', 'cterm': 'none' }
let s:fg = { 'gui': '#e3e3e3', 'cterm': 231 }
let s:invisibles = { 'gui': '#65738e', 'cterm': 66 }
let s:comments = { 'gui': '#505651', 'cterm': 145 }
...
let s:red = { 'gui': '#DC4954', 'cterm': 203 }
let s:orange = { 'gui': '#E47756', 'cterm': 209 }
let s:yellow = { 'gui': '#C8B029', 'cterm': 11 }
let s:green = { 'gui': '#60D25A', 'cterm': 2 } " 186 –– almost perfect match
let s:cyan = { 'gui': '#17C2E5', 'cterm': 117 }
let s:blue = { 'gui': '#4555E7', 'cterm': 111 }
let s:paleblue = { 'gui': '#b2ccd6', 'cterm': 152 }
let s:purple = { 'gui': '#7245CD', 'cterm': 176 }
let s:brown = { 'gui': '#c9a475', 'cterm': 137 }
let s:pink = { 'gui': '#DD26DD', 'cterm': 204 }
let s:violet = { 'gui': '#7741A4', 'cterm': 139 }
...
call s:SetHighlight('Include', s:green, '', '')
call s:SetHighlight('Define', s:blue, '', '')
call s:SetHighlight('Macro', s:orange, '', '')
